...
public class EmailService {
	...
	@Autowired
	private SpringTemplateEngine templete;
	...
	public void enviarPedidoConfirmacaoCadastro(String destino, String codigo) throws MessagingException {
		...
		context.setVariable("titulo", "Bem-vindo a Clínica Especialidades Médicas");
		...
		String html = templete.process("email/confirmacao", context);
		helper.setTo(destino);
		helper.setText(html, true);
		helper.setSubject("Confirmação de cadastro");
		helper.setFrom("no-reply@clinica.com");
